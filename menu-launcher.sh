...
SCRIPT_DESC=(
    ...
    [disk-space.sh]="Mostra espaco disponivel nos discos (SSD/NVMe/HDD)"
    [partitions-list.sh]="Lista todas as particoes (montadas ou nao) com tipo de disco"
    ...
    [batch-rename.sh]="Renomeia arquivos em lote por padrao (find/replace, prefixo, sufixo)"
    [package-list-backup.sh]="Exporta/importa lista de pacotes instalados"
    [video-catalog-organizer.sh]="Organiza catalogo de videos por estrategia (content/year/quality)"
    [pomodoro-timer.sh]="Timer Pomodoro com notificacoes"
    ...
    [pdf-to-jpg.sh]="Converte arquivos .pdf em imagens JPG"
    [jpg-to-text.sh]="Extrai texto de imagens JPG via OCR (Tesseract)"
    [xlsx-to-csv.sh]="Converte arquivos .xlsx para CSV, extraindo cada aba separadamente"
    [ris-to-csv.sh]="Converte arquivos .ris (citacoes bibliograficas) para CSV"
    ...
    [nerd-font-install.sh]="Baixa e instala fontes Nerd Fonts para o sistema"
    ...
    [fix-exec-bit.sh]="Remove bit de execucao de arquivos de dados (extensoes seguras)"
    ...
    [video-to-audio.sh]="Extrai a trilha de audio de arquivos de video"
    [audio-to-text.sh]="Transcreve arquivos de audio locais via Whisper"
    ...
    [archive-manager.sh]="Compacta pastas individualmente ou descompacta arquivos em massa"
...
SCRIPT_CATEGORY=(
    ...
    [disk-space.sh]="Sistema e Manutencao"
    [partitions-list.sh]="Sistema e Manutencao"
    ...
    [batch-rename.sh]="Sistema e Manutencao"
    [package-list-backup.sh]="Sistema e Manutencao"
    [pomodoro-timer.sh]="Produtividade e Notas"
    ...
    [video-catalog-organizer.sh]="Sistema e Manutencao"
    ...
    [pdf-to-jpg.sh]="Produtividade e Notas"
    [jpg-to-text.sh]="Produtividade e Notas"
    [xlsx-to-csv.sh]="Produtividade e Notas"
    [ris-to-csv.sh]="Produtividade e Notas"
    ...
    [nerd-font-install.sh]="Instalacao e Execucao"
    ...
    [fix-exec-bit.sh]="Sistema e Manutencao"
    [md-to-pdf.sh]="Produtividade e Notas"
    [yt-transcript.sh]="Produtividade e Notas"
    [video-to-audio.sh]="Produtividade e Notas"
    [audio-to-text.sh]="Produtividade e Notas"
    ...
    [archive-manager.sh]="Sistema e Manutencao"
